...
export default function Home() {
  return (
    <>
      ...
      <NextSeo
        title="Harizibam V"
        description="Explore the professional portfolio of Harizibam V, a skilled React and Frontend Developer with 2 years of hands-on experience. Discover innovative projects, expertise in modern web technologies, and a passion for creating seamless user experiences."
