...
export default function About() {
  return (
    <>
      <NextSeo
        title="Harizibam V"
        description="Learn more about Harizibam, a dedicated React and Frontend Developer with 2 years of experience. Discover the journey, skills, and passion that drive me to create innovative and user-friendly web solutions."
        canonical={`${siteMetadata.siteUrl}/about`}
        openGraph={{
          url: `${siteMetadata.siteUrl}/about`,
          title: "Learn About Harizibam V - React and Frontend Developer",
          description:
