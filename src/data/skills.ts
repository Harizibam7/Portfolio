...
export const SKILLS_DATA: SkillsShowcaseProps["skills"] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Github", icon: Github_Svg },
      { name: "Docker", icon: DockerSvg },
      { name: "AWS", icon: AwsSvg },
      { name: "Terraform", icon: Terraform_Svg },
      { name: "Ansible", icon: Ansible_Svg },
      { name: "Jenkins", icon: Jenkins_Svg },
      { name: "Bash", icon: Bash_Svg },
